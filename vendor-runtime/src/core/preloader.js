 ...
 * modulepreloadリンクを追加
 */
function addModulePreloadLink(href, crossorigin) {
 ...
 * ```
 */
export async function preloadCoreDependencies(options = {}) {
 ...
 */
export function preloadCoreDependenciesWhenIdle(options = {}, timeout = 2000) {
 ...
 * ```
 */
export function generatePreloadHTML(baseUrl = '') {
 ...
 * ```
 */
export function generateLinkHeader(baseUrl = '') {
    return CORE_DEPENDENCIES
