...
var _DadsHamburgerMenuButton_instances, _DadsHamburgerMenuButton_base, _DadsHamburgerMenuButton_iconSvg, _DadsHamburgerMenuButton_iconPath, _DadsHamburgerMenuButton_label, _DadsHamburgerMenuButton_syncState, _DadsHamburgerMenuButton_normalizeAttributes, _DadsHamburgerMenuButton_syncAriaLabel;
import { DelegatingPropertyAttr, PropertyAttr, html, } from '../../core/web-components.js';
...
function resolveLabel(type, lang) {
    if (type === 'close')
        return lang === 'en' ? 'CLOSE' : '閉じる';
    return lang === 'en' ? 'MENU' : 'メニュー';
}
function resolveIcon(variant, type, lang) {
    if (variant === 'icon') {
        if (type === 'close')
            return lang === 'en' ? ICON_VARIANT_CLOSE_EN : ICON_VARIANT_CLOSE_JA;
        return lang === 'en' ? ICON_VARIANT_MENU_EN : ICON_VARIANT_MENU_JA;
    }
    if (type === 'close')
        return STANDARD_CLOSE_ICON;
...
export class DadsHamburgerMenuButton extends TypographyWebComponent {
    constructor() {
        super(...arguments);
        _DadsHamburgerMenuButton_instances.add(this);
        _DadsHamburgerMenuButton_base.set(this, null);
        _DadsHamburgerMenuButton_iconSvg.set(this, null);
        _DadsHamburgerMenuButton_iconPath.set(this, null);
        _DadsHamburgerMenuButton_label.set(this, null);
    }
    connectedCallback() {
        super.connectedCallback();
        __classPrivateFieldSet(this, _DadsHamburgerMenuButton_base, this.shadowRoot?.querySelector('#base'), "f");
        __classPrivateFieldSet(this, _DadsHamburgerMenuButton_iconSvg, this.shadowRoot?.querySelector('#icon-svg'), "f");
        __classPrivateFieldSet(this, _DadsHamburgerMenuButton_iconPath, this.shadowRoot?.querySelector('#icon-path'), "f");
        __classPrivateFieldSet(this, _DadsHamburgerMenuButton_label, this.shadowRoot?.querySelector('#label'), "f");
        ...
        __classPrivateFieldGet(this, _DadsHamburgerMenuButton_instances, "m", _DadsHamburgerMenuButton_syncState).call(this);
    }
...
_DadsHamburgerMenuButton_base = new WeakMap(), _DadsHamburgerMenuButton_iconSvg = new WeakMap(), _DadsHamburgerMenuButton_iconPath = new WeakMap(), _DadsHamburgerMenuButton_label = new WeakMap(), _DadsHamburgerMenuButton_instances = new WeakSet(), _DadsHamburgerMenuButton_syncState = function _DadsHamburgerMenuButton_syncState() {
    if (!__classPrivateFieldGet(this, _DadsHamburgerMenuButton_instances, "m", _DadsHamburgerMenuButton_normalizeAttributes).call(this))
        return;
    ...
    if (__classPrivateFieldGet(this, _DadsHamburgerMenuButton_label, "f"))
        __classPrivateFieldGet(this, _DadsHamburgerMenuButton_label, "f").textContent = label;
    if (__classPrivateFieldGet(this, _DadsHamburgerMenuButton_iconSvg, "f"))
        __classPrivateFieldGet(this, _DadsHamburgerMenuButton_iconSvg, "f").setAttribute('viewBox', icon.viewBox);
    if (__classPrivateFieldGet(this, _DadsHamburgerMenuButton_iconPath, "f"))
        __classPrivateFieldGet(this, _DadsHamburgerMenuButton_iconPath, "f").setAttribute('d', icon.path);
    __classPrivateFieldGet(this, _DadsHamburgerMenuButton_instances, "m", _DadsHamburgerMenuButton_syncAriaLabel).call(this, label);
}, _DadsHamburgerMenuButton_normalizeAttributes = function _DadsHamburgerMenuButton_normalizeAttributes() {
    const variant = normalizeVariant(this.getAttribute('variant'));
    ...
    return true;
}, _DadsHamburgerMenuButton_syncAriaLabel = function _DadsHamburgerMenuButton_syncAriaLabel(fallbackLabel) {
    const base = __classPrivateFieldGet(this, _DadsHamburgerMenuButton_base, "f");
    if (!base)
        return;
    const explicit = this.getAttribute('aria-label')?.trim() ?? '';
    base.setAttribute('aria-label', explicit || fallbackLabel);
};
DadsHamburgerMenuButton.definition = {
